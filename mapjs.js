...
jQuery(document).ready(function($) {
  ...
  initializeMap();
  $.getJSON("https://script.google.com/macros/s/AKfycbwOTZO_ZuBza0T_xx9bQWl8NSTcLXTbLd8uzKw3kdo1Q9asKyZL/exec?categoryId=2&prefix=?", function (data) { displayMarkersByCategory(data, 2); } );
